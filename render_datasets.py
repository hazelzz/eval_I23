...
render_folder = r"D:\wyh\eval_I23\GSO_render_datasets_25"
...
for i, f in enumerate(files):
    ...
    # Delete the existing images in the render folder
    # existing_images = os.listdir(os.path.join(render_path, "model"))
    # for image in existing_images:
    #     image_path = os.path.join(render_path, "model", image)
...
source_folder = r"GSO_render_datasets_25"
files = os.listdir(source_folder)
for f in files:
